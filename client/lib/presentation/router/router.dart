...
@MaterialAutoRouter(
  ...
  routes: <AutoRoute>[
    AutoRoute<SplashPage>(page: SplashPage), //!set initial:true
    AutoRoute<LoginPage>(page: LoginPage, initial: true),
    AutoRoute<RegisterPage>(page: RegisterPage, initial: true),
